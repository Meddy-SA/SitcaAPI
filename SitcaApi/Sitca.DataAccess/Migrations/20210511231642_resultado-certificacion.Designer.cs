...
namespace Sitca.DataAccess.Migrations
{
    ...
    [Migration("20210511231642_resultado-certificacion")]
    partial class resultadocertificacion
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sitca.Models.NotifiyUsers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Sitca.Models.NotifiyUsers", b =>
                {
                    b.HasOne("Sitca.Models.Notificacion", "Notificaciones")
                        .WithMany()
                        .HasForeignKey("NotificacionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Sitca.Models.ApplicationUser", "UsuarioNotificacion")
                        .WithMany()
                        .HasForeignKey("UsuarioId");
                });
            ...
            modelBuilder.Entity("Sitca.Models.ProcesoCertificacion", b =>
                {
                    ...
                    b.HasOne("Sitca.Models.ResultadoCertificacion", "Resultado")
                        .WithMany()
