...
public static class Utilities
{
    ...
    public static string GetEstado(this decimal? input, string leng)
    {
        ...
        if (leng == "es")
        {
            switch (input)
            {
                case 0:
                    return "0 - Inicial";
                case 1:
                    return "1 - Para Asesorar";
                case 2:
                    return "2 - Asesoria en Proceso";
                case 3:
                    return "3 - Asesoria Finalizada";
                case 4:
                    return "4 - Para Auditar";
                case 5:
                    return "5 - Auditoria en Proceso";
                case 6:
                    return "6 - Auditoria Finalizada";
                case 7:
                    return "7 - En revisión de CTC";
                case 8:
                    return "8 - Finalizado";
                default:
                    return "";
        ...
        switch (input)
        {
            case 0:
                return "0 - Start";
            case 1:
                return "1 - For consulting";
            case 2:
                return "2 - Consultancy underway";
            case 3:
                return "3 - Consultancy completed";
            case 4:
                return "4 - For auditing";
            case 5:
                return "5 - Auditing underway";
            case 6:
                return "6 - Audit completed";
            case 7:
                return "7 - Under CCT Review";
            case 8:
                return "8 - Completed";
        }
        return "";
    ...
    {
        return value != null
            ? string.Format(CultureInfo.InvariantCulture, "{0:n}", value.Value)
            : null;
    }
